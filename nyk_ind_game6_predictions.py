# -*- coding: utf-8 -*-
"""nyk_ind_game6_predictions.ipynb
...
def playoffAverages(team, stats, n=17):
  return team.tail(n)[metrics].mean().round(3).to_dict()

knicks_avgs = playoffAverages(knicks2025_sorted, metrics, n=17)
pacers_avgs = playoffAverages(pacers2025_sorted, metrics, n=17)
...
print("For the 2025 Eastern Conference Finals between the New York Knicks and the Indiana Pacers, here are each team's chance of winning Game 6:  ")
...
For the 2025 Eastern Conference Finals between the New York Knicks and the Indiana Pacers, here are each team's chance of winning Game 6:  
New York Knicks Chance of Winning: 49.198%
Indiana Pacers Chance of Winning: 50.802%
