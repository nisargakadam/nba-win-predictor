# -*- coding: utf-8 -*-
"""nyk_ind_game5_predictions.ipynb
...
knicks2025_sorted = knicks2025_sorted[:-2]
...
pacers2025_sorted = pacers2025_sorted[:-2]

knicks2025_sorted

metrics = ['FG_PCT', 'FG3_PCT', 'REB', 'AST', 'STL', 'BLK', 'TOV', 'PLUS_MINUS']

def playoffAverages(team, stats, n=16):
  return team.tail(n)[metrics].mean().round(3).to_dict()

knicks_avgs = playoffAverages(knicks2025_sorted, metrics, n=16)
pacers_avgs = playoffAverages(pacers2025_sorted, metrics, n=16)
...
print("For the 2025 Eastern Conference Finals between the New York Knicks and the Indiana Pacers, here are each team's chance of winning Game 5:  ")
...
For the 2025 Eastern Conference Finals between the New York Knicks and the Indiana Pacers, here are each team's chance of winning Game 5:  
New York Knicks Chance of Winning: 48.387%
Indiana Pacers Chance of Winning: 51.613%
