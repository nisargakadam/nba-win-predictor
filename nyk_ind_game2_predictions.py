# -*- coding: utf-8 -*-
"""NYK-IND_Game2_Predictions.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1XTZFp7xGgHvH4-AAIDBL-8_tEAXgpsdh
"""
...
def playoffAverages(team, stats, n=13):
  return team.tail(n)[metrics].mean().round(3).to_dict()

knicks_avgs = playoffAverages(knicks2025_sorted, metrics, n=13)
pacers_avgs = playoffAverages(pacers2025_sorted, metrics, n=13)
