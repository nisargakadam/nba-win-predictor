# -*- coding: utf-8 -*-
"""NYK-IND_Game3_Predictions.ipynb
...
knicks_avgs = playoffAverages(knicks2025_sorted, metrics, n=14)
pacers_avgs = playoffAverages(pacers2025_sorted, metrics, n=14)
...
print("For the 2025 Eastern Conference Finals between the New York Knicks and the Indiana Pacers, here are each team's chance of winning Game 2:  ")
...
'''
For the 2025 Eastern Conference Finals between the New York Knicks and the Indiana Pacers, here are each team's chances of winning Game 3:  
New York Knicks Chance of Winning: 47.849%
Indiana Pacers Chance of Winning: 52.151%
...
pacers_recent = pacers2025_sorted.tail(13).copy()
